...
def load_data():
    st.session_state['df'], st.session_state['df_debitos'], st.session_state['df_debitos_speedmilhas'], st.session_state['df_estoque'] = concatenar_planliha_de_custos_faturamento()
